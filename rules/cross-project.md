...
- Shared services map (which database instance, CRM, messaging service is used by which project)
- Tech stack of each project

**Read this file** when you need context about other projects, especially when:
- Working with shared database instances (beware of schema changes affecting other projects)
...
- **Shared DB instances:** Before any DB schema migration on a shared backend, check which other projects use it and warn the user — track shared-instance project IDs in `.shared-context.md`
